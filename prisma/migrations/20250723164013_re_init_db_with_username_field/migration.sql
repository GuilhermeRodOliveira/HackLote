...
INSERT INTO "new_User" ("bio", "country", "createdAt", "email", "failedLoginAttempts", "id", "isActivityPublic", "isProfilePublic", "lockoutUntil", "nome", "password", "preferredCurrency", "preferredLanguage", "profilePictureUrl", "receiveInAppNotifications", "receiveMarketingEmails", "receiveMessageNotifications", "receiveOrderUpdates", "theme", "updatedAt", "usuario") SELECT "bio", "country", "createdAt", "email", "failedLoginAttempts", "id", "isActivityPublic", "isProfilePublic", "lockoutUntil", "nome", "password", "preferredCurrency", "preferredLanguage", "profilePictureUrl", "receiveInAppNotifications", "receiveMarketingEmails", "receiveMessageNotifications", "receiveOrderUpdates", "theme", "updatedAt", "usuario" FROM "User";
DROP TABLE "User";
